...
export const GlobalChatPage: React.FC = () => {
  ...
  <div className="mx-auto flex w-full max-w-[1500px] flex-1 min-h-0 flex-col gap-1 overflow-hidden px-4 pt-1 pb-[2px] sm:px-6 sm:pt-1.5 sm:pb-[2px] lg:px-10 lg:pt-2 lg:pb-[2px]">
        <ChannelSidebar
