...
export const MangaReviews: React.FC<MangaReviewsProps> = ({
  ...
  return (
    <div className="space-y-8">
      {/* Rating Summary */}
      <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
                <div className="mb-6">
                  <div className="text-6xl font-black bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 bg-clip-text text-transparent mb-3">
                        ...
                        <div key={rating} className="group">
                          <div className="flex items-center gap-4 mb-1">
                            <div className="flex items-center gap-2 w-12">
                              <span className="text-sm font-bold text-white w-6">{rating}</span>
                            ...
                            <div className="flex-1 relative">
                              ...
                              {percentage > 10 && (
                                <span className="absolute right-2 top-0 text-xs font-bold text-white/90 leading-3">
                                  {percentage.toFixed(0)}%
                                </span>
                              )}
                            </div>
                            <span className="text-sm font-medium text-gray-300 w-8 text-right">{count}</span>
                          </div>
                        </div>
                      );
                    })}
        ...
        {reviews.length === 0 ? (
          <div className="text-center py-12 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10">
            <div className="text-gray-400 mb-4">
              ...
              <p className="text-lg text-white">Пока нет отзывов</p>
              <p className="text-sm">Станьте первым, кто оставит отзыв об этой манге!</p>
            </div>
          </div>
        ) : (
