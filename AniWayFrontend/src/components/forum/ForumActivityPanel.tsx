...
export function ForumActivityPanel({ stats }: { stats: ForumActivityStats }) {
  ...
  if (!hasContent) {
    return (
      <div className="glass-panel rounded-2xl border border-white/10 bg-background/80 p-5">
  ...
  return (
    <div className="glass-panel flex h-full flex-col rounded-2xl border border-white/10 bg-background/80 p-5">
      <div>
            ...
            {trending.map((thread) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center gap-2 rounded-xl bg-white/5 px-3 py-2 text-left text-xs text-white/70 transition hover:bg-white/10 hover:text-white"
                >
            ...
            {recent.map((thread) => {
              ...
              return (
                <Link
                  ...
                  to={`/forum/thread/${thread.id}`}
                  className="flex items-center gap-3 rounded-xl bg-white/5 px-3 py-2 text-left text-xs text-white/70 transition hover:bg-white/10 hover:text-white"
                >
