...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleFriendServiceException(FriendServiceException exception) {
        HttpStatus status = exception.getStatus();
        log.debug("FriendService exception: {}", exception.getMessage());
